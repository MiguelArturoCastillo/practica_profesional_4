...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <ul class="navbar">
            <li><a href="listado_materia.php"class="active" >MATERIAS</a></li>
...
<div class="feature-content">
    ...
    <div class="row row3">
        <div class="main-row">
        <div>        
<a href="buscar_materia.php" class="btn">BUSCAR MATERIAS</a>
<a href="formulario_materia.php" class="btn">AGREGAR MATERIAS</a>
