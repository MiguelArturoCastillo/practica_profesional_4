...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <ul class="navbar">
                <li><a href="listado_docente.php"class="active" >LISTADO DOCENTE</a></li>
                <li><a href="menu_gral.html" >INICIO</a></li>
                <li><a href="listado_alumno.php"class="active" >LISTADO ALUMNOS</a></li>                
                <li><a href="listado_curso.php">LISTADO CURSOS</a></li>
            </ul>
            <div class="icons">
...
<div class="feature-content">
    <div class="row row3">
        <div class="main-row">
            <div class="row-text">
    <h1>RESULTADO DE LA BUSQUEDA DE OBJETO DOCENTE</H1>
    <?php
    ...
    $obj_docente->mostrar_docente($id);
     ...
     <BR>
     <BR>
 <a href="buscar_docente.php" class="btn">VOLVER</a> 
 </div>
        </div>
    </div>
</div>   
