...
<head>
    ...
    <a href="#" class="logo"><img src="logo.jpg"></a>
            <ul class="navbar">
                <li><a href="escuela1_gral" class="active">INICIO</a></li>
                <li><a href="listado_docente.php">LISTADO DOCENTE</a></li>
...
?>
<br>
<a href="listado_docente.php"class="btn" >VOLVER AL REGISTRO DE DOCENTES</a>
            </div>
        </div>
    </div>
